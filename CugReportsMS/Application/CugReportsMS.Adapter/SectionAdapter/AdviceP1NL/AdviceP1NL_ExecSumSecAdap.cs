...
{
    public class AdviceP1NL_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new AdviceP1NL_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as AdviceP1NL_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public AdviceP1NL_ExecSumSecAdap()
        {
            SectionModel = new AdviceP1NL_ExecSumSecModel();
        }
