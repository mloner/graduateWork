...
{
    public class MeasurementNL_AnalysisSecAdap : PdfSectionAdapter
    {
        protected new MeasurementNL_AnalysisSecModel SectionModel
        {
            get => base.SectionModel as MeasurementNL_AnalysisSecModel;
            set => base.SectionModel = value;
        }

        public MeasurementNL_AnalysisSecAdap()
        {
            SectionModel = new MeasurementNL_AnalysisSecModel();
        }
