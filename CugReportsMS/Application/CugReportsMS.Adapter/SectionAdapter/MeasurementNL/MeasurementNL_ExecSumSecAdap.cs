...
{
    public class MeasurementNL_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new MeasurementNL_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as MeasurementNL_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public MeasurementNL_ExecSumSecAdap()
        {
            SectionModel = new MeasurementNL_ExecSumSecModel();
        }
