...
{
    public class AdviceP1InvBE_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new AdviceP1InvBE_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as AdviceP1InvBE_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public AdviceP1InvBE_ExecSumSecAdap()
        {
            SectionModel = new AdviceP1InvBE_ExecSumSecModel();
        }
