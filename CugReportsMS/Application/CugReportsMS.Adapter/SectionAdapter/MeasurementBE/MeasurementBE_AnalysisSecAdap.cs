...
{
    public class MeasurementBE_AnalysisSecAdap : PdfSectionAdapter
    {
        protected new MeasurementBE_AnalysisSecModel SectionModel
        {
            get => base.SectionModel as MeasurementBE_AnalysisSecModel;
            set => base.SectionModel = value;
        }

        public MeasurementBE_AnalysisSecAdap()
        {
            SectionModel = new MeasurementBE_AnalysisSecModel();
        }
