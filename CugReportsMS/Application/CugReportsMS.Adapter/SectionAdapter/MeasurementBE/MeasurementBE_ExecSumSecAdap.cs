...
{
    public class MeasurementBE_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new MeasurementBE_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as MeasurementBE_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public MeasurementBE_ExecSumSecAdap()
        {
            SectionModel = new MeasurementBE_ExecSumSecModel();
        }
