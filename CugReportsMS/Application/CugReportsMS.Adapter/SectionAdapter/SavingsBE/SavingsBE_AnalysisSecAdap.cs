...
{
    public class SavingsBE_AnalysisSecAdap : PdfSectionAdapter
    {
        protected new SavingsBE_AnalysisSecModel SectionModel
        {
            get => base.SectionModel as SavingsBE_AnalysisSecModel;
            set => base.SectionModel = value;
        }

        public SavingsBE_AnalysisSecAdap()
        {
            SectionModel = new SavingsBE_AnalysisSecModel();
        }
