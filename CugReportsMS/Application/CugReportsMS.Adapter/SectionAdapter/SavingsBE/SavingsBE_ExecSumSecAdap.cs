...
{
    public class SavingsBE_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new SavingsBE_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as SavingsBE_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public SavingsBE_ExecSumSecAdap()
        {
            SectionModel = new SavingsBE_ExecSumSecModel();
        }
