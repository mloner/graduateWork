...
{
    public class AdviceP1InvNL_AnalysisSecAdap : PdfSectionAdapter
    {
        protected new AdviceP1InvNL_AnalysisSecModel SectionModel
        {
            get => base.SectionModel as AdviceP1InvNL_AnalysisSecModel;
            set => base.SectionModel = value;
        }

        public AdviceP1InvNL_AnalysisSecAdap()
        {
            SectionModel = new AdviceP1InvNL_AnalysisSecModel();
        }
