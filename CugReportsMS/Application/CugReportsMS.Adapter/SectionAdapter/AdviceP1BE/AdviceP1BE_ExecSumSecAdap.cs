...
{
    public class AdviceP1BE_ExecSumSecAdap : PdfSectionAdapter
    {
        protected new AdviceP1BE_ExecSumSecModel SectionModel
        {
            get => base.SectionModel as AdviceP1BE_ExecSumSecModel;
            set => base.SectionModel = value;
        }

        public AdviceP1BE_ExecSumSecAdap()
        {
            SectionModel = new AdviceP1BE_ExecSumSecModel();
        }
