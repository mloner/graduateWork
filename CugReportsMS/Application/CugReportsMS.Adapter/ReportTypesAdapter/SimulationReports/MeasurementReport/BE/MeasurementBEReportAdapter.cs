...
namespace ReportingFramework.ReportTypesAdapter.SimulationReports.MeasurementReport.BE
{
    public class MeasurementBEReportAdapter : MeasurementReportAdapter
    {
        public MeasurementBEReportAdapter(
            ...
            : base(reportAdapterParameters, reportRepository, logger)
        {
            ...
            {
                PdfSectionEnum.MeasurementBE_Title,
                PdfSectionEnum.MeasurementBE_ExecSum,
                PdfSectionEnum.MeasurementBE_Analysis
            };
        }
