...
namespace ReportingFramework.ReportTypesAdapter.SimulationReports.SavingsReport.NL
{
    public class SavingsNLReportAdapter : SavingsReportAdapter
    {
        public SavingsNLReportAdapter(
            ...
            : base(reportAdapterParameters, reportRepository, logger)
        {
            ...
            {
                PdfSectionEnum.SavingsNL_Title,
                PdfSectionEnum.SavingsNL_ExecSum,
                PdfSectionEnum.SavingsNL_Analysis,
            };
        }
