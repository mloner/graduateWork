...
namespace ReportingFramework.ReportTypesAdapter.SimulationReports.SavingsReport.BE
{
    public class SavingsBEReportAdapter : SavingsReportAdapter
    {
        public SavingsBEReportAdapter(
            ...
            : base(reportAdapterParameters, reportRepository, logger)
        {
            ...
            {
                PdfSectionEnum.SavingsBE_Title,
                PdfSectionEnum.SavingsBE_ExecSum,
                PdfSectionEnum.SavingsBE_Analysis,
            };
        }
