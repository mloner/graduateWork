...
namespace ReportingFramework.ReportTypesAdapter.SimulationReports.AdviceP1InvReport.BE
{
    public class AdviceP1InvBEReportAdapter : AdviceP1InvReportAdapter
    {
        public AdviceP1InvBEReportAdapter(
            ...
            : base(reportAdapterParameters, reportRepository, logger)
        {
            ...
            {
                PdfSectionEnum.AdviceP1InvBE_Title,
                PdfSectionEnum.AdviceP1InvBE_ExecSum,
                PdfSectionEnum.AdviceP1InvBE_Analysis
            };
        }
