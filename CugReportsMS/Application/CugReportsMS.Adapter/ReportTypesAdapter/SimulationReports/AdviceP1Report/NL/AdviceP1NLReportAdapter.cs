...
namespace ReportingFramework.ReportTypesAdapter.SimulationReports.AdviceP1Report.NL
{
    public class AdviceP1NLReportAdapter : AdviceP1ReportAdapter
    {
        public AdviceP1NLReportAdapter(
            ...
            : base(reportAdapterParameters, reportRepository, logger)
        {
            ...
            {
                PdfSectionEnum.AdviceP1NL_Title,
                PdfSectionEnum.AdviceP1NL_ExecSum,
                PdfSectionEnum.AdviceP1NL_Analysis
            };
        }
