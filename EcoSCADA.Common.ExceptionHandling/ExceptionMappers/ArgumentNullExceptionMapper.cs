...
{
    public class ArgumentNullExceptionMapper
    {
        private readonly ExceptionHandlingConfiguration _exceptionHandlingConfiguration;
        private readonly ILogger<ArgumentNullExceptionMapper> _logger;

        public ArgumentNullExceptionMapper(
            ExceptionHandlingConfiguration exceptionHandlingConfiguration, 
            ILogger<ArgumentNullExceptionMapper> logger
        )
        {
        ...
        internal ExceptionResponse SetArgumentNullExceptionResponse(ArgumentException ex, ProblemDetailsExtensions extensions)
        {
            const string code = "Argument not found";
