...
{
    public class DQValid_GapsSection : ExcelReportSection
    {
        private new DQValid_GapsSectionModel SectionModel;

        public DQValid_GapsSection()
        {
            TemplateFileName = "DQValidReport/Template_DQValidReport_Gaps.xlsx";
        }
        public override void InitSectionModel(string sectionModelJson)
        {
            base.InitSectionModel(sectionModelJson);
            SectionModel = JsonSerializer.Deserialize<DQValid_GapsSectionModel>(sectionModelJson);
        }

        public override void GenerateContent()
        {
            //find table
            var table = Worksheet.Table("Table_Gaps");
