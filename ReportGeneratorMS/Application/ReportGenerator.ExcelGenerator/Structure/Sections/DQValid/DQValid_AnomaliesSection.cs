...
{
    public class DQValid_AnomaliesSection : ExcelReportSection
    {
        private new DQValid_AnomaliesSectionModel SectionModel;

        public DQValid_AnomaliesSection()
        {
            TemplateFileName = "DQValidReport/Template_DQValidReport_Anomalies.xlsx";
        }
        public override void InitSectionModel(string sectionModelJson)
        {
            base.InitSectionModel(sectionModelJson);
            SectionModel = JsonSerializer.Deserialize<DQValid_AnomaliesSectionModel>(sectionModelJson);
        }

        public override void GenerateContent()
        {
            //find table
            var table = Worksheet.Table("Table_Anomalies");
